...
class MainActivity : AppCompatActivity() {
    ...
    private val gattCallback = object : BluetoothGattCallback() {
        ...
        override fun onCharacteristicChanged(gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic) {
            if (characteristic.uuid == charFreqUUID) {
                ...
                val onlyDigits = raw.substringBefore(".")
                runOnUiThread {
                    freqText.text = onlyDigits
                }
            }
        }
    }
    ...
    private fun startBLEScan() {
        ...
        val filter = ScanFilter.Builder().setDeviceName(bleDeviceName).build()
    ...
    private fun sendFrequency(freq: Int) {
        ...
        Toast.makeText(this, "Sent $freq", Toast.LENGTH_SHORT).show()
    }
